...
surv_plot <- ggsurvplot(
  ...
  legend.title = "Podtyp PAM50", 
    # Czcionki
  font.main = c(20, "bold"),      # Tytuł wykresu
  font.x = c(20),                 # Oś X
  font.y = c(20),                 # Oś Y
  font.tickslab = c(20),         # Etykiety osi
  font.legend = c(15),           # Legenda
  font.caption = c(20) 
)

# Otwórz urządzenie graficzne PNG
png("krzywe_przezycia_z_tabela.png", width = 3000, height = 2000, res = 150)

# Rysujemy cały obiekt graficzny (wykres + tabela ryzyka)
print(surv_plot)
